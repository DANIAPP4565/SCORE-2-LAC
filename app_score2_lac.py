...
# INTERFAZ PRINCIPAL
# -----------------------------------------------------------------------------
st.markdown('<div class="main-header">🫀 SCORE2-LAC: Calculadora de Riesgo Cardiovascular</div>', unsafe_unsafe_html=True)
...
with tab_sim:
    ...
    with col_s1:
        ...
        pas_sim = st.slider("Simular Meta de PAS (mmHg)", min_value=100, max_value=int(pas), value=int(pas), step=5)
    ...
    with col_s2:
        ...
        st.markdown(f"**Nueva Categoría Simulatana:** <span class='risk-badge {cat_sim_clase}' style='font-size:1rem;'>{cat_sim_nombre}</span>", unsafe_allow_html=True)
